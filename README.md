...
![Version: 21.1.3-bb.0](https://img.shields.io/badge/Version-21.1.3--bb.0-informational?style=flat-square) ![AppVersion: 8.0.1](https://img.shields.io/badge/AppVersion-8.0.1-informational?style=flat-square) ![Maintenance Track: bb_maintained](https://img.shields.io/badge/Maintenance_Track-bb_maintained-yellow?style=flat-square)
...
| sentinel.image.tag | string | `"8.0.1-debian-12-r0"` |  |
...
| volumePermissions.image.tag | string | `"12-debian-12-r44"` |  |
...
| kubectl.image.tag | string | `"1.33.1-debian-12-r0"` |  |
...
| sysctl.image.tag | string | `"12-debian-12-r44"` |  |
