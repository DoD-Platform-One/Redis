...
![Version: 16.4.0-bb.0](https://img.shields.io/badge/Version-16.4.0--bb.0-informational?style=flat-square) ![AppVersion: 6.2.5](https://img.shields.io/badge/AppVersion-6.2.5-informational?style=flat-square)
...
| master.topologySpreadConstraints | object | `{}` |  |
...
| replica.startupProbe.enabled | bool | `false` |  |
| replica.startupProbe.initialDelaySeconds | int | `20` |  |
...
| replica.startupProbe.failureThreshold | int | `5` |  |
...
| replica.topologySpreadConstraints | object | `{}` |  |
...
| sentinel.image.tag | string | `"6.2.6-debian-10-r118"` |  |
...
| sentinel.startupProbe.enabled | bool | `false` |  |
| sentinel.startupProbe.initialDelaySeconds | int | `20` |  |
...
| sentinel.startupProbe.failureThreshold | int | `5` |  |
...
| metrics.image.tag | string | `"1.29.0"` |  |
...
| volumePermissions.image.tag | string | `"10-debian-10-r329"` |  |
...
| sysctl.image.tag | string | `"10-debian-10-r329"` |  |
